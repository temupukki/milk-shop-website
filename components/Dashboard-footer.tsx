...
export default function DashboardFooter(){
    ...
    <footer className=" bg-rose-200 text-rose-800 py-12 w-full p-0 m-0">
      <div className="max-w-[1340px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link href="/dashboard/products" className="hover:text-green-500 transition">
                Produts
              </Link>
            </li>
            <li>
              <Link href="/dashboard/about" className="hover:text-green-500 transition">
                About
              </Link>
            </li>
            <li>
              <Link href="/dashboard/contact" className="hover:text-green-500 transition">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <Link href="/dashboard/faq" className="hover:text-green-500 transition">
                FAQ
              </Link>
            </li>
           
            <li>
              <Link href="/dashboard/privacy" className="hover:text-green-500 transition">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/dashboard/terms" className="hover:text-green-500 transition">
                Terms of Service
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-500 text-sm">
        &copy; {new Date().getFullYear()} Pukkimilk. All rights reserved.
      </div>
    </footer>
  );
