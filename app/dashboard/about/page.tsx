        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              Milk Haven began in 1985 when Grandpa Henry bought his first dairy cow, Bessie. 
              What started as a small family operation has grown into a beloved local dairy, 
              but we've never lost sight of our roots.
            </p>
            <p className="text-gray-700 mb-6">
              Today, we still milk our cows by hand twice daily, refusing to compromise on 
              quality for scale. Every bottle of Milk Haven carries three generations 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-rose-50 p-6 rounded-xl text-center hover:shadow-md transition">
                <div className="flex justify-center mb-4">
                  {value.icon}
                </div>
                <h3 className="text-xl font-bold text-rose-800 mb-2">{value.title}</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-rose-800">{member.name}</h3>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-rose-600 hover:bg-rose-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition">
             <Link href="/dashboard/products"> Shop Our Products</Link>
            </button>
            <button className="bg-white hover:bg-rose-50 text-rose-700 font-semibold py-3 px-8 rounded-full shadow-lg border border-rose-200 transition">
              <Link href="/dashboard/contact">Visit the Farm</Link>
            </button>
          </div>
        </div>
      </section>
