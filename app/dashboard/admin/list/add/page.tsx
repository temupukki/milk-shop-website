  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md border border-rose-100 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-rose-800 mb-2">Add New Product</h1>
          <p className="text-rose-600">Fill in the details below to create a new product</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-rose-800 mb-1">Product Name*</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-rose-800 mb-1">Price*</label>
              ...
              <div>
                <label className="block text-sm font-medium text-rose-800 mb-1">Stock Quantity*</label>
                <input
                  type="number"
                  name="stock"
                  min="1"
            ...
            <div>
              <label className="block text-sm font-medium text-rose-800 mb-1">Image URL</label>
              <input
                type="text"
                name="image"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-rose-800 mb-1">Category*</label>
                <select
                  name="category"
              ...
              <div>
                <label className="block text-sm font-medium text-rose-800 mb-1">Rating (0-5)</label>
                <input
                  type="number"
                  step="0.1"
                  min="0"
            ...
            <div>
              <label className="block text-sm font-medium text-rose-800 mb-1">Description</label>
              <textarea
                name="description"
