          ...
          <table className="w-full">
            <thead className="bg-rose-50">
              <tr>
                ...
                <th className="p-4 text-left text-rose-800 font-semibold">Email</th>
                <th className="p-4 text-left text-rose-800 font-semibold">Message</th>
                <th className="p-4 text-left text-rose-800 font-semibold">Date</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-rose-100">
              {submissions.map((submission) => (
                <tr key={submission.id} className="hover:bg-rose-50 transition-colors">
                  <td className="p-4 font-medium text-rose-700 flex items-center gap-2">
                  ...
                  <td className="p-4 text-rose-700 flex items-center gap-2">
